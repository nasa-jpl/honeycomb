...
import { AutoFieldList } from '../MaterialAutoField';
...
import { LabeledTelemetryAnimatorGraph } from '../TelemetryAnimatorGraph';
    ...
    renderMenu = () => {
        ...
        return (
            <React.Fragment>
                ...
                <div
                    className={`${styles.staleIcon} ${viewer.animator.stale ? '' : displayStyles.hidden
                        }`}
                />
                {buttons}
